...
#	if use http2; then
#		EPATCH_OPTS = "-p1" \
#		epatch "${FILESDIR}/http2-all.patch"
#	fi
...
src_configure() {
	...
	if [[ $http_enabled ]] ; then
		...
		use ssl && nginx_configure+=" --with-http_ssl_module --with-http_v2_module"
